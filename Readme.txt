...
-Na direita do displau, temos as informações C e S. C representa a amostra atual que é coletada e S a quantidade total de amostras que serão coletadas;
-A cada 30 amostras da temperatura (C) capturadas, o display atualiza a informação da temperatura atual baseado na média dessas 30 amostras coletadas (S);
